...
#include "ff9/src/option/syscall.c"
...
int selectFatFsCS(int to_select);
...
{
  spiReadWrite(SD_SPI, 0, buff, bc, Speed, selectFatFsCS);
}
...
{
  spiReadWrite(SD_SPI, buff, 0, bc, Speed, selectFatFsCS);
}
